        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="flex">
                        <a href="/login" class="text-gray-500 font-semibold hover:text-gray-800">Login</a>
                        <a href="/register" class="ml-4 text-gray-500 font-semibold hover:text-gray-800">Register</a>
                    </div>
