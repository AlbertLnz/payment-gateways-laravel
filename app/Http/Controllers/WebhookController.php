...
class WebhookController extends Controller
{
        ...
        if ($user) {
            ...
            if (! $user->subscriptions->contains('stripe_id', $data['id'])) {
                ...
                $subscription = $user->subscriptions()->create([
                    'name' => $data['metadata']['name'] ?? $this->newSubscriptionName($payload), // <--- metadata object empty. Goes to newSubscriptionName() function
                    'stripe_id' => $data['id'],
    ...
    {
        return 'Suscripciones blog'; // <---- Instead of 'default' value, put my subscription name: 'Suscripciones blog'
    }
